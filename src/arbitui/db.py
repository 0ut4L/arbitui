...
INIT_RATE_DATA = """
    INSERT OR IGNORE INTO rate VALUES 
        ...
        ('EUR', 'ESTR10Y', '{"currency": "EUR", "tenor": "10Y", "spot_lag": 2, "floating_rate": "ESTR12M", "fixed_period": "12M", "fixed_day_counter": "Act360", "payment_delay": 2, "calendar": "world", "bd_convention": "ModifiedFollowing", "discount_curve": {"currency": "EUR", "name": "ESTR"}, "type": "SwapRate"}'),
        ...
        ('USD', 'SOFR10Y', '{"currency": "USD", "tenor": "10Y", "spot_lag": 2, "floating_rate": "SOFR12M", "fixed_period": "12M", "fixed_day_counter": "Act360", "payment_delay": 2, "calendar": "world", "bd_convention": "ModifiedFollowing", "discount_curve": {"currency": "USD", "name": "SOFR"}, "type": "SwapRate"}');
"""
